...
export const GetTodo = createAsyncThunk('todo/GetTodo', async (params: any, { getState }: any) => {
  const user = Cookies.get('user');
...
export const uploadFile = createAsyncThunk(
  ...
  async (params: any, { getState }: any) => {
    ...
    const storageRef = ref(
      storage,
      getState().todo.current_todo.tasks[getState().todo.current_index_task].file
    );
...
export const getFile = createAsyncThunk('todo/getFile', async (params: any, { getState }: any) => {
  const storage = getStorage();
